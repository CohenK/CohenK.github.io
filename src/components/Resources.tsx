...
// const mainColor = [79, 79, 79];

// let newColor = [96, 16, 129];
// let offset = [
//   newColor[0] - mainColor[0],
//   newColor[1] - mainColor[1],
//   newColor[2] - mainColor[2],
// ];

// const app = document.querySelector(".")! as HTMLElement;

function Resources() {
  // window.addEventListener("scroll", () => {
  //   let y = 1 + (window.scrollY || window.pageYOffset) / 10;
  //   y = y < 0 ? 0 : y; // ensure y is always >= 1 (due to Safari's elastic scroll)
  //   let [r, g, b] = [
  //     mainColor[0] + offset[0] / y,
  //     mainColor[1] + offset[1] / y,
  //     mainColor[2] + offset[2] / y,
  //   ].map(Math.round);
  ...
  return (
    <section className="ResourcesPage">
      <section className="resource">
        <p className="resourcesTitle">resources</p>
        ...
        <p className="alternateOption">
          &#x2193; Alternatively, you can use the built-in emailing section
          below &#x2193;
        </p>
      </section>
